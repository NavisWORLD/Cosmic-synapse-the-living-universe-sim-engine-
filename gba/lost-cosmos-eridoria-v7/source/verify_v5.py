...
rom=root/'LOST_COSMOS_ERIDORIA_V7.gba'
...
if data[0xA0:0xAC] != b'ERIDORIAV7  ': fail('title mismatch')
if data[0xAC:0xB0] != b'ERV7': fail('game code mismatch')
if data[0xB2] != 0x96: fail('fixed header byte mismatch')
if data[0xBC] != 8: fail('software version mismatch')
