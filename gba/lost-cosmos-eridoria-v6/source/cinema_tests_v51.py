...
int main(void){
 ...
 puts("PASS: 8 authentic 4bpp cinema scenes, VRAM-safe BG2 overlay, separate PSG audio, 1-button touch dodge, V5 save migration, touch-heavy, replay isolation");
 return 0;
}
'''
