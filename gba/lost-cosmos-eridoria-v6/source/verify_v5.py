...
rom=root/'LOST_COSMOS_ERIDORIA_V6_PREVIEW.gba'
...
if data[0xA0:0xAC] != b'ERIDORIAV6  ': fail('title mismatch')
if data[0xAC:0xB0] != b'ERV6': fail('game code mismatch')
if data[0xB2] != 0x96: fail('fixed header byte mismatch')
if data[0xBC] != 7: fail('software version mismatch')
