...
rom=root/'SIM_EARTH_PIXEL_UNIVERSE_LOST_COSMOS_V5_CINEMATIC.gba'
...
if data[0xA0:0xAC] != b'LOSTCOSMOS51': fail('title mismatch')
if data[0xAC:0xB0] != b'LC51': fail('game code mismatch')
if data[0xB2] != 0x96: fail('fixed header byte mismatch')
if data[0xBC] != 6: fail('software version mismatch')
