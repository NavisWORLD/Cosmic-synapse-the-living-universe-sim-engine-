...
rom=root/'SIM_EARTH_PIXEL_UNIVERSE_LOST_COSMOS_V5.gba'
...
if data[0xA0:0xAC] != b'LOSTCOSMOSV5': fail('title mismatch')
if data[0xAC:0xB0] != b'LCV5': fail('game code mismatch')
if data[0xB2] != 0x96: fail('fixed header byte mismatch')
if data[0xBC] != 5: fail('software version mismatch')
